...
const CVPage = ( props ) => {
    ...
    return (
        ...
        <Layout>
            ...
            <h2 class={cvStyles.cvCaption}>English <a href="https://www.batikanor.com/l/cv/en" target="_blank" rel="noreferrer"> (Click for fullscreen)</a> <a href="https://www.batikanor.com/l/cv/en" target="_blank" rel="noreferrer"> (Click for PDF)</a> </h2>
            <div className={cvStyles.cvDiv}>
            <iframe className={cvStyles.cv} title="English CV" width="100%" height="100%" seamless src="https://docs.google.com/document/d/e/2PACX-1vTI_n0Epv5KdWd5cO9d_78Lbvzvpb2gN7IqtrOPrYEpLHBd9islycKCqAk3BoDcH0fEOMzypmLvVQan/pub?embedded=true"></iframe>
